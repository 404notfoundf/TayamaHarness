...
import com.tayama.prd.ingestion.model.prd.*;
...
public class PrdIngestionRepository {
    ...
    public com.tayama.prd.ingestion.model.document.WikiDocument findDocument(String docId) {
        List<com.tayama.prd.ingestion.model.document.WikiDocument> results = jdbc.query(
                ...
                (rs, row) -> {
                    com.tayama.prd.ingestion.model.document.WikiDocument doc = new com.tayama.prd.ingestion.model.document.WikiDocument();
